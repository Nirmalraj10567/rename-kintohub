...
<b>Send me any Telegram file and reply to that file with /rename NewName.extn</b>"""
    ...
    DOWNLOAD_START = "wait few. minutes 🚶🚶🚶"
    ...
    NOT_AUTH_USER_TEXT = "CONTACT @infinitrocyberlegend"
    NOT_AUTH_USER_TEXT_FILE_SIZE = "IF You Got This Message You Should Contact @infinitrocyberlegend"
